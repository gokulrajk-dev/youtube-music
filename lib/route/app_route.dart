...
import '../module/pages/Song_search/bindings/search_binding.dart';
import '../module/pages/Song_search/views/search_views.dart';
...
import '../module/pages/playlist_page/playlist_binding.dart';
import '../module/pages/playlist_page/playlist_view.dart';
...
class App_route {
  ...
  static final route = [
    ...
    GetPage(
        ...
        middlewares: [auth_guard()]),
    GetPage(name: main_home_pages, page: () => const MainHomePage(), bindings: [
      Main_Home_Page_Binding(),
      Album_Binding(),
      Init_Binding(),
      Artist_Binding()
    ], middlewares: [
    ...
    GetPage(
      name: explore_page,
      page: () => Explore_Views(),
      binding: Explore_Binding(),
    ),
    GetPage(
        name: library_page,
        page: () => const Library_Views(),
        binding: Library_Binding()),
    GetPage(
      name: profile_page,
      page: () => const Profile_Views(),
      binding: Profile_binding(),
      transition: Transition.downToUp,
    ),
    GetPage(
      name: full_screen_media_player_page,
      page: () => const full_screen_media_player(),
      binding: full_player_binding(),
    ),
    GetPage(name: like_page, page: () => Like_Views(), binding: Like_Binding()),
    GetPage(
        name: download_page,
        page: () => Download_Views(),
        binding: download_binding()),
    GetPage(
        name: playlist_page,
        page: () => Playlist_Views(),
        binding: Playlist_Binding()),
    GetPage(
        name: album_page, page: () => Album_Views(), binding: Album_Binding()),
    GetPage(
        name: history_page,
        page: () => History_Views(),
        binding: Histroy_Binding()),
    GetPage(name: artist_page, page: () => Artist_Views()),
    GetPage(name: search_page, page: ()=>const SearchViews(),binding: SearchSongBinding()),
  ];
}
